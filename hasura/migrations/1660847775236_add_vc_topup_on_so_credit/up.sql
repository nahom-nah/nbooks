CREATE OR REPLACE VIEW "public"."so_credit_view" AS 
 SELECT sub.id,
    ...
    ((COALESCE(sub.deposits, (0)::numeric) - COALESCE(sub.vc_topups, (0)::numeric) - COALESCE(sub.telebirr_topups, (0)::numeric)) - COALESCE(sub.transfers, (0)::numeric)) AS difference,
